...
function FounderCard() {
  return (
    <SpotlightCard
      ...
      className="group h-full rounded-[2rem] shadow-sm dark:shadow-black/50 border border-stone-200/60 dark:border-white/10 bg-white/60 dark:bg-black/20 backdrop-blur-md transition-all duration-500 hover:shadow-md hover:-translate-y-1"
    >
