...
function Footer() {
  return (
    <footer className="relative z-20 w-full pt-16 pb-8 border-t border-primary/20 shadow-[0_-10px_30px_rgba(0,0,0,0.05)] bg-gradient-to-b from-background via-accent/30 to-primary/10 dark:from-[#1e293b] dark:to-[#0f172a]">
        ...
        <div className="flex flex-col space-y-6">
          ...
          <div className="flex gap-4">
            <a
              ...
              rel="noreferrer"
              aria-label="Twitter"
              className="w-12 h-12 bg-background/50 rounded-full flex items-center justify-center shadow-sm hover:shadow-md hover:-translate-y-1 transition-all border border-primary/20 hover:border-primary/50 group"
            >
              <img
                src="https://res.cloudinary.com/dtc2xaeaf/image/upload/f_auto,q_auto:eco,w_100,c_limit/v1756746683/xIcon_xn4fbb.png"
                alt="Twitter"
                className="w-10 h-10 filter dark:invert opacity-80 group-hover:opacity-100 transition-opacity"
              />
            </a>
            <a
      ...
      {/* Centered Logos — RC TCET logo left, vertical divider, TCET logo right */}
      <div className="relative z-10 flex justify-center items-center gap-10 mt-12 mb-4">
        <img
          ...
          alt="RCTCET Logo"
          className="h-28 w-28 md:h-32 md:w-32 object-contain drop-shadow-md hover:scale-105 transition-transform"
        />
      ...
      {/* Massive Footer Text — Clean CodeRabbit-style non-overlapping outline without blurry bottom mask */}
      <div className="relative w-full mt-8 flex flex-col justify-center items-center overflow-hidden z-10 px-4 pointer-events-none select-none">
        <div
          aria-hidden="true"
