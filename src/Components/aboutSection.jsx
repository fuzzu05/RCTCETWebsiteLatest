...
const Anantya = () => {
  return (
    <>
      <div className="w-full flex justify-center pb-24 bg-background rounded-t-3xl relative z-20 overflow-hidden">
        ...
        <div className="absolute top-0 left-0 w-full h-[100px] rounded-t-3xl shadow-[0_-20px_60px_rgba(0,0,0,0.06)] dark:shadow-[0_-20px_60px_rgba(0,0,0,0.8)] -z-10"></div>
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-3/4 h-[300px] bg-primary/10 dark:bg-primary/20 blur-[100px] pointer-events-none rounded-full" />
        ...
        <div className="relative w-full overflow-hidden pt-12 lg:pt-20">
          ...
          <div className="relative z-10 flex flex-col md:flex-row h-full p-6 lg:px-24 justify-center items-center gap-12 max-w-7xl mx-auto">
            ...
            <div className="flex-grow md:w-1/2 p-8 md:p-10 rounded-3xl bg-white/80 dark:bg-black/20 backdrop-blur-md border border-primary/10 dark:border-white/10 shadow-sm transition-transform hover:-translate-y-1 duration-500 relative overflow-hidden group">
