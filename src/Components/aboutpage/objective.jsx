...
const FloatingCard = ({ obj, index, delay }) => (
  ...
  >
    <motion.div
      ...
      className="group relative bg-white/70 dark:bg-black/30 backdrop-blur-md border border-stone-200/50 dark:border-white/10 rounded-[2.5rem] p-8 lg:p-10 hover:border-primary/60 hover:bg-white/85 dark:hover:bg-black/40 transition-all duration-500 overflow-hidden shadow-sm hover:shadow-md z-30"
    >
