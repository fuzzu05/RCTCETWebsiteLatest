    ...
    <div className="bg-card dark:bg-card min-h-screen">
      ...
      <Suspense fallback={<div>Loading...</div>}>
        ...
        >
          <Link
            to="/meet-the-team"
            className="relative group bg-gradient-to-r from-primary to-secondary text-white font-bold text-lg py-4 px-10 rounded-full shadow-lg shadow-primary/30 hover:shadow-xl hover:shadow-primary/50 transition-all duration-500 hover:-translate-y-1 overflow-hidden"
          >
