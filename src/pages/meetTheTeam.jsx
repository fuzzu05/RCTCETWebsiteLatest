              ...
              {filteredMembers.map((member, index) => (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-0 w-full p-6 sm:p-8 flex flex-col justify-end z-20 transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500 text-center">
                    <div className="w-12 h-1.5 bg-gradient-to-r from-primary to-secondary rounded-full mx-auto mb-5 opacity-0 group-hover:opacity-100 transition-opacity duration-500 delay-100 shadow-[0_0_10px_rgb(var(--primary)/0.5)]" />
